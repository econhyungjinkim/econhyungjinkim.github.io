...
> <details><summary>Abstract</summary> This paper proposes a new method for the estimation and inference of static discrete game models with many market characteristics. To allow for a data-driven selection of characteristics, I incorporate double/debiased machine learning (DML) into the estimation of static games within complete information. I combine the tools I developed to study the strategic entry decisions of independent pharmacies in rural regions in the Midwestern United States. This application is well-suited because the market characteristics that influence pharmacy openings and their functional forms are often unknown to researchers. I document that 1) the exit of independent pharmacies from rural towns is associated with the entry of new chain pharmacies in urbanized areas; 2) these industry shifts contribute to increasingly limited pharmacy access in rural towns; and 3) these trends are more pronounced in towns where over 20% of the population is aged 65 and older. My structural estimation shows that the impact of a competing independent pharmacy on profits is 50% larger, compared to the existing estimators. This substantial difference arises from the machine learning methods’ ability to detect and utilize complex non-linear relationships, thereby enhancing the predictive power of the entry choice probabilities of rivals. In rural towns with a high elderly population ratio, the estimated model suggests that chain pharmacy entries could account for 40% of the closures of independent pharmacies between 2000 and 2019. I conduct policy simulations showing that subsidies can reduce the number of rural towns previously identified as having limited pharmacy access by 16%. 
